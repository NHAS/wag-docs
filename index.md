...
title: Wag
titleTemplate: MFA, Route restriction and device enrolment + Wireguard

hero:

  width: 1300
  text: 'Wireguard Authentication Gateway'
  actions:
    - theme: brand
      text: What is Wag?
      link: /what-is-wag
    ...
    - theme: alt
      text: Support
      link: https://github.com/NHAS/wag/discussions

features:
  - title: Run
    details: Install anywhere containers run, supports docker and podman.
  ...
  - title:  Authenticated
    details: Single sign-on, webauthn, TOTP and PAM, it's your choice.
  ...
  - title: Automated
    details: Enrol devices, manage routes.
  ...
  - title: Safe
    details: Never lose your connectivity with redunancy.
